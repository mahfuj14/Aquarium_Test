...
void Skybox::draw(Shader* shader, Shader* skyboxShader) {
    shader->use();
    ...
    glm::mat4 scaleMatrix = glm::scale(identityMatrix, glm::vec3(8,5,8));
    glm::mat4 translateMatrix = glm::translate(identityMatrix, glm::vec3(0, 2.5, 0));
